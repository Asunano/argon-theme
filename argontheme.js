...
!function(){
	...
	console.log('%chttps://github.com/solstice23/argon-theme (original)', 'font-size: 12px;border-radius:5px;padding:3px 10px 3px 10px;border:1px solid #5e72e4;');
